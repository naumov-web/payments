...
class SubscriptionRepository:
    ...
    async def create(self, subscription: SubscriptionModel) -> None:
    ...
    async def get_active_subscription(
        ...
        *,
        ...
        query = (
            ...
            .where(SubscriptionModel.subscriber_actor_id == subscriber_actor_id)
            .where(SubscriptionModel.service_actor_id == service_actor_id)
