...
async def get_transaction_by_id(transaction_id: UUID):
    use_case = GetTransactionByIdUseCase(uow=UnitOfWork())

    try:
        result = await use_case.execute(transaction_id=transaction_id)
    ...
    return TransactionDetailsResponse(
        ...
        sender_actor_id=result["sender_actor_id"],
        sender_name=result["sender_name"],
        receiver_actor_id=result["receiver_actor_id"],
